...
CPainterView::CPainterView()
{
	...
	m_hcurEllipse = AfxGetApp()->LoadCursor(IDC_CURSOR_ELLIPSE);
	m_hcurStar = AfxGetApp()->LoadCursor(IDC_CURSOR_STAR);
	m_hcurSpline = AfxGetApp()->LoadCursor(IDC_CURSOR_SPLINE);
...
void CPainterView::AddShape(int shape, CPoint first_point, CPoint second_point) 
{
	...
	case OP_PICTURE:
		...
		pShape->SetPen(RGB(200, 0, 0), 100, PS_GEOMETRIC);
		// �����-����� ������������ ���������
		pShape->SetBrush(RGB(0, 0, 0),IDB_PATTERN8);
	break;
	case OP_ELLIPSE:
		// ������� ������ - �������
		pShape = new CEllipse(first_point.x, first_point.y, size * 2);
		// ������� ����� ������� 1 ��
	...
	case OP_STAR:
		...
		// ������� ����� ������� 1 ��
		pShape->SetPen(RGB(0, 0, 0), 10, PS_GEOMETRIC);
		// �����-����� ������������ ���������
		pShape->SetBrush(RGB(0, 204, 0));
		break;
	case OP_SPLINE:
		pShape = new CSpline();
		//((CSpline*)pShape)->CSpline::SetCenter(first_point.x, first_point.y, size * 2);
		//Добавляем точки для сглаживания
		((CSpline*)pShape)->CSpline::AddPoints(first_point.x, first_point.y, size * 2);
		// ������� ����� ������� 1 ��
		pShape->SetPen(RGB(0, 0, 0), 10, PS_GEOMETRIC);
		// �����-����� ������������ ���������
		pShape->SetBrush(RGB(0, 204, 0));
